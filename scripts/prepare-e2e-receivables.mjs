...
await prisma.$executeRawUnsafe(
  'CREATE SCHEMA IF NOT EXISTS cashledger_e2e_receivables',
);
await prisma.$disconnect();

const envPath = '/var/www/cashledger/apps/api/.env';
const target = '/var/www/cashledger/apps/api/.env.e2e-receivables';
const url = new URL(process.env.DATABASE_URL);
url.searchParams.set('schema', 'cashledger_e2e_receivables');
...
console.log('E2E receivables schema and env prepared');
