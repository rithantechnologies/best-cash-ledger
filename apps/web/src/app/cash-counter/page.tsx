...
export default function CashCounterPage(){
 ...
 return <AppShell><div className="mx-auto max-w-6xl space-y-6">
  <div><h2 className="text-2xl font-bold">Cash Counter</h2><p className="text-sm text-slate-500">Opening and physical closing denomination count with expected-vs-actual difference.</p></div>
  ...
  <section className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
   ...
   <div className="rounded-xl border bg-white p-5"><h3 className="font-semibold">Recent Sessions</h3>
