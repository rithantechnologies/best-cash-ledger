            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
              ...
              <div>
                ...
                <div className="mt-2 grid grid-cols-2 gap-1 rounded-xl bg-[var(--surface-soft)] p-1 sm:grid-cols-4">
                  ...
                  <button type="button" onClick={()=>{setCommissionMode("PERCENT");setManualCommissionAmount("");}} className={"min-h-10 rounded-lg px-2 text-[11px] font-bold "+(commissionMode==="PERCENT"?"bg-[var(--surface)] text-[var(--accent)] shadow-sm":"text-[var(--text-muted)]")}>Custom %</button>
                  <button type="button" onClick={()=>{setCommissionMode("AMOUNT");setManualCommissionAmount(commission>0?String(Number(commission.toFixed(2))):"");}} className={"min-h-10 rounded-lg px-2 text-[11px] font-bold "+(commissionMode==="AMOUNT"?"bg-[var(--surface)] text-[var(--accent)] shadow-sm":"text-[var(--text-muted)]")}>Commission amount ₹</button>
