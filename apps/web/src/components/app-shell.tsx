    ...
    <div className="lg:pl-64">
      <header className="app-topbar sticky top-0 z-30 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--surface)_90%,transparent)] backdrop-blur-xl">
        <div className="flex h-15 items-center gap-3 px-3 sm:px-5 lg:px-6">
          ...
          <div className="min-w-0 flex-1 lg:flex-none"><p className={"truncate font-bold tracking-[-.015em] "+(isTaskFlow?"text-base":"text-sm")}>{currentTitle}</p></div>
          ...
          <Link href="/transactions/new" className="app-primary-button hidden min-h-10 items-center gap-2 px-4 text-sm font-bold sm:flex"><Icon name="plus" className="h-4 w-4"/>New</Link></>:<div className="hidden flex-1 lg:block"/>}
        </div>
      </header>
